        ...
        return (
            <div>
                ...
                <ul className="main_sub-secs profile_links-container">
                    <li><a target ="_blank" href="https://codepen.io/jermestes" className="profile_links">
                        <img src="images/profile_icons/codepen/Button-Black-Large.png" 
                        alt="" className="profile_links_images" />Codepen</a>
                    </li>

                    <li><a target ="_blank" href="https://dribbble.com/jermestes" className="profile_links">
                        <img src="images/profile_icons/dribbble/dribbble-ball-icon.png" 
                        alt="" className="profile_links_images" />Dribbble</a>
                    </li>

                    <li><a target ="_blank" href="https://github.com/jermestes" className="profile_links">
                    ...
                    <li><a target ="_blank" href="https://www.linkedin.com/in/jeremy-estes/" className="profile_links">
